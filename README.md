...
| Bölgesel Su Muhasebesi ve Kooperatif Haritası Altyapısı | Sistemi Canlı Sunucuya (Vercel / VPS) Taşıma İşlemleri | | **(2 Puan)** Open-Meteo API Entegrasyonu ve Hata Yönetimi |
